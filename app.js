...
function renderScheduleCard(container, sc) {
        ...
        const roles = [
            ...
            { label: "Soprano", id: sc.vocal1 },
            { label: "Contralto", id: sc.vocal2 },
            { label: "Tenor", id: sc.vocal3 },
            { label: "Som", id: sc.som },
...
function shareFullScale(scaleId) {
    ...
    const rolesList = [
        ...
        { label: "Soprano", name: getMemberNameText(sc.vocal1) },
        { label: "Contralto", name: getMemberNameText(sc.vocal2) },
        { label: "Tenor", name: getMemberNameText(sc.vocal3) },
